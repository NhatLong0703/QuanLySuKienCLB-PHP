...
class AuditLog implements JsonSerializable {
    ...
    public function jsonSerialize(): mixed {
        return ['id'=>$this->id,'user_id'=>$this->userId,'action'=>$this->action,'target_table'=>$this->targetTable,'target_id'=>$this->targetId,'detail'=>$this->detail,'created_at'=>$this->createdAt];
    }
}
